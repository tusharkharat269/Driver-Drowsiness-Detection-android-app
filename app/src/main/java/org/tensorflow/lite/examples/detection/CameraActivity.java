...
//    fatigueMonitor = new FatigueMonitor(CameraActivity.this);
//    activityMonitor = new ActivityMonitor(CameraActivity.this);
    safetyAlarmSystem = new DriverSafetyAlarmSystem(CameraActivity.this);

    testAlertButton = findViewById(R.id.testAlertButton);

//    testAlertButton.setOnClickListener(view -> fatigueMonitor.triggerAlert("anythidng"));
    testAlertButton.setOnClickListener(view -> safetyAlarmSystem.vibrate());
